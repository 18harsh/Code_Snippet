...
# mycursor.execute("""CREATE TABLE stu_details
# (
...
# )
# """)
         insert_query="INSERT INTO stu_details(registrationNo,candidateName,address,email,mobile,landlineno,birthdate,startdate,enddate,gender) VALUES('"+ reg_number.get() +"','"+ cand_name.get() +"','"+ address.get() +"','"+ email.get() +"','"+ mobile.get() +"','"+ landline.get() +"','"+ birthDateObj.strftime("%Y-%m-%d") +"','"+ startDateObj.strftime("%Y-%m%d") +"','"+ endDateObj.strftime("%Y-%m-%d") +"','"+ genderValue.get() +"');"
...
regNumEntry.bind("<Return>", lambda event: validate(event, "Registrationnumber"))
