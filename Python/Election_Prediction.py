...
df = pd.DataFrame()
for f in ('C:\\Users\\Harsh\\Desktop\\code\\python\\time series\\2009maharashtraresults.xlsx',
          'C:\\Users\\Harsh\\Desktop\\code\\python\\time series\\2014maharashtraresults.xlsx'):
        data = pd.read_excel(f, 'Sheet1') #this loop merges the two excel sheets into one.
        df = df.append(data)
        df.to_excel("C:\\Users\\Harsh\\Desktop\\code\\python\\time series\\combineddata.xlsx")#resultant data is stored in this third excel sheet
        data = pd.read_excel("C:\\Users\\Harsh\\Desktop\\code\\python\\time series\\combineddata.xlsx")
print(data)
